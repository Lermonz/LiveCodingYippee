...
const pad =  n(`<
     ...
     <[1,4,9,12] [3,5,10b,13]>
     [0,<4 5>,9,13]
     <<[<0!2 1>,5,10,[13 12@3]] [1,4,10,12]>!7 [1,5b,9,13b]>
     >`)
  .scale("F3:major")
  .sound("square")
  .vib("3.1:0.15")
...
const wind = s("white*12")
  ...
  .release(0.5)
  .hpf(500)
  .lpf(perlin.range(550,1100).slow(4))
  .gain(tri.range(1,8).slow(32))
...
$: pick(sections, `<[0,4,11]@24 
[0,4,11,5,6]@16 [5,6,11,0,1,9]@16 
[3,6,1,9]@16 [3,6,1,10]@16 
[6,7,0,5,8]@8 
[6,7,0,5,1,<9@8 2@8>]@16 
[6,7,3,0,4]@16 [0,11,<4@8 ~@8>]@16 
~@999>`)
all(x=>x.fast(1.11))
